...
| **prompt_settings** | Configure the bot's system prompt behavior. On default, llmcord will add Today's date to the prompt. You can disable this by setting `add_date` to `false`. |
